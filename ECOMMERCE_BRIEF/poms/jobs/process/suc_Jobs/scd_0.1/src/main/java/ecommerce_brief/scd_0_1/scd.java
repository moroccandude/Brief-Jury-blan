...
package ecommerce_brief.scd_0_1;
...
private class TalendException extends Exception {
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = scd.class.getClassLoader().getResourceAsStream("ecommerce_brief/scd_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     22751 characters generated by Talend Open Studio for Data Integration 
 *     on the 5 février 2025, 10:28:49 UTC+01:00
 ************************************************************************************************/